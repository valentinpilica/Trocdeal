var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="' + window.location.origin + '/Trocdeal/assets/themes/trocdeal/css/theme-default.css"><img src="' + window.location.origin + '/Trocdeal/assets/themes/trocdeal/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="' + window.location.origin + '/Trocdeal/assets/themes/trocdeal/css/theme-brown.css"><img src="' + window.location.origin + '/Trocdeal/assets/themes/trocdeal/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="' + window.location.origin + '/Trocdeal/assets/themes/trocdeal/css/theme-blue.css"><img src="' + window.location.origin + '/Trocdeal/assets/themes/trocdeal/img/themes/blue.jpg"/></a>'                        
            +'<a href="#" data-theme="' + window.location.origin + '/Trocdeal/assets/themes/trocdeal/css/theme-white.css"><img src="' + window.location.origin + '/Trocdeal/assets/themes/trocdeal/img/themes/light.jpg"/></a>'            
            +'<a href="#" data-theme="' + window.location.origin + '/Trocdeal/assets/themes/trocdeal/css/theme-black.css"><img src="' + window.location.origin + '/Trocdeal/assets/themes/trocdeal/img/themes/black.jpg"/></a>'
        +'</div>'
