		...
		<div class="navbar-inner">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					class="brand" href="<?php echo site_url(); ?>">&nbsp;&nbsp;Your
					Brand</a>
				<div style="height: 0px;" class="nav-collapse collapse">
					<ul class="nav">
						<li class="active"><a href="<?php echo site_url('page/index'); ?>">Home</a></li>
						<li><a href="<?php echo site_url('page/login'); ?>">Login</a></li>
						<li><a href="<?php echo site_url('page/signUp'); ?>">Sign Up</a></li>
						<li><a href="<?php echo site_url('page/forgottenPassword'); ?>">Forgotten your password?</a></li>
			...
			<div class="row">
				<div class="span6 b10">
					Copyright &copy; <a target="_blank"
						href="#">Valentin Pilica</a> | <a target="_blank"
						href="http://www.trocdeal.com">www.trocdeal.com</a>
				</div>
			</div>
		</footer>
