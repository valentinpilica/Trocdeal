...
<div class="page-container">
	...
	<div class="page-sidebar">
		...
		<ul class="x-navigation">
			<li class="xn-logo"><a href="index.html">Joli Admin</a> <a href="#"
			...
			<li class="<?php echo activateMenu('profile'); ?>"><a
				href="<?php echo site_url('profile/index'); ?>"> <span
					class="fa fa-user"></span> <span class="xn-text">Profile</span>
			</a></li>
			<li class="xn-title">Navigation</li>
			<li class="<?php echo activateMenu('dashboard'); ?>"><a
				href="<?php echo site_url('dashboard/index'); ?>"><span
					class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>
			</li>
			<li class="<?php echo activateMenu('messages'); ?>"><a
				href="<?php echo site_url('messages/index'); ?>"> <span
					class="fa fa-comments"></span> <span class="xn-text">Messages</span>
			</a></li>
			<li class="<?php echo activateMenu('comments'); ?>"><a
				href="<?php echo site_url('comments/index'); ?>"><span
					class="fa fa-user"></span> <span class="xn-text">Comments</span></a></li>
		</ul>
		<!-- END X-NAVIGATION -->
	</div>
	<!-- END PAGE SIDEBAR -->
				...
				<div
					...
					<div class="panel-body list-group list-group-contacts scroll"
						...
						<a href="#" class="list-group-item">
							...
							src="<?php echo base_url(); ?>assets/themes/<?php echo $this->config->item('default_theme_name'); ?>/assets/images/users/user2.jpg"
							class="pull-left" alt="John Doe" /> <span class="contacts-title">John
								Doe</span>
							<p>Praesent placerat tellus id augue condimentum</p>
						</a> <a href="#" class="list-group-item">
							<div class="list-group-status status-away"></div> <img
							src="<?php echo base_url(); ?>assets/themes/<?php echo $this->config->item('default_theme_name'); ?>/assets/images/users/user.jpg"
							class="pull-left" alt="Dmitry Ivaniuk" /> <span
							class="contacts-title">Dmitry Ivaniuk</span>
							<p>Donec risus sapien, sagittis et magna quis</p>
						</a> <a href="#" class="list-group-item">
							<div class="list-group-status status-away"></div> <img
							src="<?php echo base_url(); ?>assets/themes/<?php echo $this->config->item('default_theme_name'); ?>/assets/images/users/user3.jpg"
							class="pull-left" alt="Nadia Ali" /> <span class="contacts-title">Nadia
								Ali</span>
							<p>Mauris vel eros ut nunc rhoncus cursus sed</p>
						</a> <a href="#" class="list-group-item">
							<div class="list-group-status status-offline"></div> <img
							src="<?php echo base_url(); ?>assets/themes/<?php echo $this->config->item('default_theme_name'); ?>/assets/images/users/user6.jpg"
							class="pull-left" alt="Darth Vader" /> <span
							class="contacts-title">Darth Vader</span>
			...
			<li class="xn-icon-button pull-right"><a href="#"><span
				...
				<div
					...
					<div class="panel-body list-group scroll" style="height: 200px;">
						<a class="list-group-item" href="#"> <strong>Phasellus augue arcu,
								elementum</strong>
						...
						</a> <a class="list-group-item" href="#"> <strong>Aenean ac cursus</strong>
							<div class="progress progress-small progress-striped active">
								...
								80%</small>
						</a> <a class="list-group-item" href="#"> <strong>Lorem ipsum
								dolor</strong>
							<div class="progress progress-small progress-striped active">
						...
						</a> <a class="list-group-item" href="#"> <strong>Cras suscipit ac
								quam at tincidunt.</strong>
...
<div class="message-box animated fadeIn" data-sound="alert"
	...
	<div class="mb-container">
		<div class="mb-middle">
			...
			<div class="mb-footer">
				<div class="pull-right">
					<a href="<?php echo base_url() ?>/index.php/login/logout_user"
